              ...
              <!-- Input addon -->
               <c:if test="${not empty result}">
                <div class="alert alert-success alert-dismissable">
                      ...
                      <h4>  <i class="icon fa fa-check"></i> Proyecto evaluado correctamente.</h4>
                      Los evaluacdores han sido asignados con éxito.
                </div>
              </c:if>
                      ...
                      <table class="table table-hover">  
                         ...
                         <c:forEach var="emp" items="${list}">   
                           <tr>  
                               ...
                               <td> <a href="${contextPath}/evaluarPro?id=${emp.codp}&t=<%=t%>"><button class="btn btn-primary">Evaluar proyecto</button></a></td>
